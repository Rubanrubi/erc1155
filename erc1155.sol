 ...
 */
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI,Ownable,Pausable{
...
contract BlackHeart is Ownable,ERC1155 {
...
///////////////////////////
  function bulkMint1(address[] memory _to, uint[] memory _ids, uint[] memory _amounts) external payable {
      for(uint256 i=0;i < _to.length ; i++){
       _mint(_to[i], _ids[i], _amounts[i], "");   
      }
  }

    function bulkMint2(address[] memory _to,uint[][] memory _ids, uint[][] memory _amounts) external payable {
        for(uint256 i = 0; i < _to.length ; i++)
        {
